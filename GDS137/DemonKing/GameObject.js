...
{	
	...
	this.drawRect = function () {
		ctx.save();
		ctx.fillStyle =  this.color //"rgba(12,240,229,0)";
	...
	this.drawScore = function()
	{
		...
		ctx.fillStyle = "rgb(116, 16, 98)"
		ctx.font = "20px Berkshire Swash"
		ctx.fillText("Score: " + pScore, 50, 40)

		ctx.fillStyle = "rgb(116, 16, 98)"
		ctx.font = "20px Berkshire Swash"
		ctx.fillText("High Score: " + highScore, 50, 80)

		ctx.restore()
	}


	this.drawHealthText = function()
	{
		ctx.save();
		ctx.fillStyle = "rgb(116, 16, 98)"
    	ctx.font = "20px Berkshire Swash"
    	ctx.fillText("Kiko's health: " + health, 775, 30)
		ctx.restore();
	}
